...
class FakePlatformEndpoints(mock.Mock):

    def __init__(self, **kwargs):
        super(FakePlatformEndpoints, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_endpoints'
        self.type = 'platform_endpoints'


class FakeCAMPEndpoint(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeCAMPEndpoint, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_V1_1_endpoint'
        self.type = 'platform_endpoint'


class FakeCAMPAssemblies(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeCAMPAssemblies, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_assemblies'
        self.type = 'assemblies'


class FakeAssemblyCreateParams(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeAssemblyCreateParams, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_assembly_create_parameters'
        self.type = 'parameter_definitions'


class FakeCAMPExtensions(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeCAMPExtensions, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_extensions'
        self.type = 'extensions'


class FakeCAMPFormats(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeCAMPFormats, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_formats'
        self.type = 'formats'


class FakeJSONFormat(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeJSONFormat, self).__init__(**kwargs)
        self.name = 'JSON'
        self.type = 'format'


class FakeCAMPPlans(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeCAMPPlans, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_plans'
        self.type = 'plans'


class FakeCAMPPlatform(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeCAMPPlatform, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_v1_1_platform'
        self.type = 'platform'


class FakeCAMPServices(mock.Mock):

    def __init__(self, **kwargs):
        super(FakeCAMPServices, self).__init__(**kwargs)
        self.name = 'Solum_CAMP_services'
        self.type = 'services'


class FakeTypeDefinitions(mock.Mock):

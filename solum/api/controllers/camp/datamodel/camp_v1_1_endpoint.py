...
class CAMP_V1_1_Endpoint(api_types.Base):
    """CAMP v1.1 platform_endpoint resource"""
    ...
    def __init__(self, **kwds):
        LOG.debug("camp_v1_1_endpoint constructor: %s" % kwds)
        super(CAMP_V1_1_Endpoint, self).__init__(**kwds)
